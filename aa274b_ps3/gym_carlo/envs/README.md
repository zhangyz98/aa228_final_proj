...
## Features
CARLO currently supports Cars and Pedestrians as the dynamic objects. They both use bicycle dynamics. Point-mass dynamics are also implemented, but commented out (see entities.py).
